package com.wanghan.microservices.configurationserver.config;

/**
 * 通用参数
 *
 * @Author WangHan
 * @Create 2019/11/24 12:13 下午
 */
public class CommonConstants {
    ...
    public static String SPRING_PROFILE_HEROKU = "heroku";
    public static String SPRING_PROFILE_AWS_ECS = "aws-ecs";
